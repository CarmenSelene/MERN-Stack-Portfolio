        ...
        <div className="d-inline">
            <div className="my-4 titleBacker">
                <span className="px-2 mx-auto">
                    <strong>Emotion Tracking Alert System [ETAS]</strong><br />
                    <span className="text-muted subTitleBacker">Microsoft AZURE AI/Machine Learning Hackathon *Finalist*</span>
                </span>
            </div>
            <div className="my-4">
            </div>
